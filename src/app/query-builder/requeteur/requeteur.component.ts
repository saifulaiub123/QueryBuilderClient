...
*/
  ...
  */
  ...
  exportPdf() {
    ...
    this.visibleSidebar1 = true;
    this.pdfTitle = this.dataSource.designation;
  ...
  */
  ...
  exportDataCsv() {
    ...
    csvExporter.generateCsv(this.dataRequest);
  }
  ...
  */
   ...
   */
  /*
  async fetchChangesForUpdate(id: number) {
    this.GetDataSource(id);

    await this.GetDataSourceTables(id);
    await this.createPtreTable();
    await this.GetDataSourceOrderBys(id);
  ...
  */
  async displayJointuresClickHandler() {
    ...
    if (this.joinedTables.length > 0) {
      ...
      //  this.msags = [{ severity: 'warn', summary: 'Note:', detail: 'To add joins, select joined tables first!' }];
    }
  ...
  /**
   * if joinded tabe changed we have to create new  tree of selected tables and fields
   */
  ...
  /**
  * if main tabe changed we have to create new  tree of selected tables and fields
  */
  ...
  /**
   *  create a tree of table selected in a query 
   *  each table contains field to select 
   *  we have the choice to select any fileds of this tree to display them in the result of the query
   *  
   */
  ...
  /**
   * turn on checkbox in fields to select  depending on selected fields of a query 
   */
  ...
  /**
   * get selected fields of a query to save them in database 
   */
  ...
  /**
  * send main table of queries to database 
  */
